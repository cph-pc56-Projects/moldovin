...
export default () => (
  ...
  <div >
    ...
    `}
     ...
     <h1> ABOUT US </h1>
      <div>MoldoVin is a wine importer and distribution company that solely wants to provide the Danish market with Moldovan wine. Hence, the name MoldoVin. 
     ...
     <h1> WHY MOLDOVA </h1>
      <div>The little known European country of Moldova is putting its name on the map for its fantastic wines. The rich flavor of these wines is fast becoming recognised by world-renowned wine experts. Moldovan wine has great texture, warmth and flavour that will surprise and delight.
